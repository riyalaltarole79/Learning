          ...
          <div className="row g-4">
            ...
            >
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">Umari, Dhawada dist Barwani Madhya Pradesh, India</p>
                </div>
              </div>
              <div className="d-flex align-items-center mb-3">
                <div
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">+91 9479877674</p>
                </div>
              </div>
              <div className="d-flex align-items-center">
                ...
                <div className="ms-3">
                  ...
                  <p className="mb-0">riyalaltarole783@gmail.com</p>
                </div>
              </div>
            </div>
            <div
            ...
            >
              <iframe
                ...
                src="https://maps.app.goo.gl/e3QAX3E7jW3P4hQo7"
                frameBorder={0}
